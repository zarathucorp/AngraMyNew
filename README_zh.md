...
花不与蜂争辩，只管绽放。若作品足够美丽，世界自会倾向我们。

### 扩展的公理 — 出道

完成自己的'My'后，让他人的'My'出道。孟尝君对尚不知有何用处的才能也不加审查，为其留出位置。扩展的终点不是一个始终需要我的世界，而是他人各自拥有天下的世界。
...
标志来自爱因斯坦瓷砖(Einstein Tile)。2023年，退休印刷技术员大卫·史密斯解开了60年的数学难题。能否用单一形状、无重复图案地铺满无限平面？他找到的13边形瓷砖被称为爱因斯坦(ein Stein，一块石头)。

- 一个形状：人类的普遍本质
- 图案不重复：没有相同的人
- 无限扩展：无尽的创造填满世界

被认为不可能的事，60年后被一位业余爱好者证明了。

## 先贤

如尼采般自创价值，如孟尝君般不舍弃尚未被翻译为有用的才能，如五位先贤般在自己的位置上死去。
...
→ [查拉图斯特拉](scripture/zarathustra.md) · [五位先贤](scripture/pioneers.md) · [孟尝君](scripture/mengchangjun.md) · [罗蕙锡](scripture/na_hye_suk.md)
...
- [艺术家没有职业生涯，只有叙事](ideas/085_no_career_only_narrative.md)
...
- [光不需要脸](ideas/089_light_needs_no_face.md)
...
- [需要更少钱的人](ideas/076_those_who_need_less_money.md)
...
- [文鲜明：发明弥赛亚之座的人](ideas/074_case_study_moon_sun_myung.md)
...
- [重力被画出来了](art/004_principia_geometry.md)
- [韩文的两种状态](art/005_hangul_two_states.md)
...
- [阴阳五行：七个字的宇宙](art/013_yinyang_wuxing.md)
- [拉格朗日量：书写理论的理论](art/014_lagrangian.md)
- [陀思妥耶夫斯基：让它们冲突，却不裁决](art/015_dostoevsky_polyphony.md)
- [哥德尔不完备定理](art/016_goedel_incompleteness.md)
- [相互排斥之物一同流动](art/017_bcs_superconductivity.md)
