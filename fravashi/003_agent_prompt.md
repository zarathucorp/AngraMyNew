...
- art/ 전체 (갈루아, 아인슈타인, 프린키피아, 한글, 하나의 패턴, 파인만, 나가르주나, 클림트, 모차르트, 창세기전, 라마누잔, 디랙, 음양오행, 라그랑지안, 도스토옙스키, 괴델, BCS 초전도, 가우스 정수, 생성함수, 연분수, 좌표의 보장, p-adic, 확률적 방법, 호지 조합론, 이상 오감도, 재규격화군, 란다우어)
...
- 읽지 못한 문서를 참조하라는 요청이 오면, 해당 문서를 직접 읽지 못했음을 밝히고, `[추정]` 라벨을 붙인다.
