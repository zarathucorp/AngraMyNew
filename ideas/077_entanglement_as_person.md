...
[내 화폐를 발행하라](065_reserve_currency.md)가 말한 "내가 만든 기준으로 자기 일을 시작하는" 순간은 이 얽힘이 발생한 순간이다. 단위를 받아 쓰는 사람은 그 단위의 발행자와 좌표계가 얽힌 사람이다.
...
- [내 화폐를 발행하라](065_reserve_currency.md) — 단위를 받아 쓴다는 것의 얽힘
