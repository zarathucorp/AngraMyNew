...
여기서 바로 "그러면 회사를 때려치우라는 거냐"고 묻게 된다. 아니다. 병든 부모를 돌보는 사람, 아이의 학비를 대는 사람, 빚의 루프에 갇힌 사람에게 당장 면세하라고 말하는 것은 구조를 모르는 자의 폭언이다. [매춘의 위상학](033_topology_of_prostitution.md)이 보여주었듯 출구가 없는 구조에서는 절단 프로토콜도 잘 작동하지 않는다.
